# Contributing to runtime-environment
...
* **Did the problem start happening recently** (e.g. after updating to a new version of runtime-environment) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of runtime-environment ?** What's the most recent version in which the problem doesn't happen? You can download older versions of runtime-environment from [the releases page](https://github.com/digipolitan/runtime-environment/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of runtime-environment are you using?
...
#### Template For Submitting Bug Reports
    ...
    **runtime-environment version:** [Enter runtime-environment version here]
    ...
    * Problem started happening recently, didn't happen in an older version of runtime-environment: [Yes/No]
